...
def main() -> int:
    p = Path("v2/reference/education_hat_v1/scenarios.json")
    data = json.loads(p.read_text(encoding="utf-8"))

    hat = EducationHatV1()
    out_dir = Path("v2/reference/education_hat_v1")
    ...
    out_path.write_text(json.dumps({"hat_id": "EDUCATION_HAT_V1", "receipts": receipts}, indent=2, sort_keys=True), encoding="utf-8")
    print(str(out_path))
    return 0
