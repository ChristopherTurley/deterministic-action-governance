...
FILES = [
    ...
    # healthcare hat frozen surfaces
    "v2/hats/healthcare_hat_v1.py",
    "v2/docs/hats/HEALTHCARE_HAT_V1.md",
    "v2/reference/healthcare_hat_v1/scenarios.json",
    "v2/reference/healthcare_hat_v1/reference_receipts.json",
