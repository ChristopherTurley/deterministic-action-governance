...
def test_executive_hat_reference_scenarios_are_stable():
    data = json.loads(Path("v2/reference/executive_hat_v1/scenarios.json").read_text(encoding="utf-8"))
    hat = ExecutiveHatV1()
    ...
    for s in data["scenarios"]:
        ...
        assert out_p.hat == "EXECUTIVE_HAT_V1"
