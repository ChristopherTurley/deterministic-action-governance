...
def test_education_hat_reference_scenarios_are_stable():
    data = json.loads(Path("v2/reference/education_hat_v1/scenarios.json").read_text(encoding="utf-8"))
    ...
    for s in data["scenarios"]:
        ...
        assert out_p.hat == "EDUCATION_HAT_V1"
        ...
        assert out_c.hat == "EDUCATION_HAT_V1"
